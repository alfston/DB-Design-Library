...
CREATE TABLE `item` (
  ...
  `lang` enum('English','French','German','Spanish','Italian') DEFAULT NULL,
  ...
  CONSTRAINT `Item_Is_A_Book` FOREIGN KEY (`ISBN`) REFERENCES `book` (`ISBN`)
...
-- Dump completed on 2020-11-15 12:04:26
